...
class AppStrings {
  static const String appTitle = 'iSee Diagnose';
  static const String planer = 'Planer';
  static const String installateur = 'Installateur';
  static const String endkunde = 'Endkunde';

  static const String herstellerSungrow = 'Sungrow';
  static const String herstellerFronius = 'Fronius';
  static const String herstellerGrowatt = 'Growatt';

  static const String fehlerBeimLaden = 'Fehler beim Laden der Daten.';
  static const String keineDaten = 'Keine Daten verfügbar.';
  static const String fehler = 'Fehler';
  static const String codeNichtGefunden = 'Code nicht gefunden';
  static const String beschreibung = 'Beschreibung';
  static const String loesung = 'Lösung';
  static const String pdfAnleitungOeffnen = 'PDF-Anleitung öffnen';
  static const String herstellerHotlineKontakt = 'Hersteller-Hotline kontaktieren';
  static const String diagnoseTitle = 'Diagnose';
  static const String komponentenWaehlen = 'Komponente wählen';
  static const String herstellerWaehlen = 'Hersteller wählen';
